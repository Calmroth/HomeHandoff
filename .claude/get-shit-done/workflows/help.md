...
- Saves timestamped note to `.planning/notes/` (or `C:/Users/chris_mm9nopi/OneDrive - IDfuel AB/PersonalProjects/design_handoff_home_control/.claude/notes/` globally)
