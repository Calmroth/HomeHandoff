...
The keys live in `.claude/settings.json` (project) or `C:/Users/chris_mm9nopi/OneDrive - IDfuel AB/PersonalProjects/design_handoff_home_control/.claude/settings.json` (global) — **not** in `.planning/config.json`:
